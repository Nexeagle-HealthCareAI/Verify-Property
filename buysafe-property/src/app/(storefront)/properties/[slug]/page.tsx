  ...
  return (
    <div style={{ paddingTop: "var(--nav-height-mobile)" }}>
      ...
      <div className="bottom-action-bar">
        <div>
          <p style={{ fontSize: "var(--text-xs)", color: "var(--color-text-muted)", marginBottom: 2 }}>Price</p>
          <p style={{ fontFamily: "var(--font-heading)", fontWeight: 700, fontSize: "var(--text-base)" }}>On Request</p>
        </div>
